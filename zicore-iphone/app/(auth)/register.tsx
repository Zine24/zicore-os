...
export default function RegisterScreen() {
  ...
  const Toggle = ({ checked, onToggle }: { checked: boolean; onToggle: () => void }) => (
    <TouchableOpacity onPress={() => { haptic.selection(); onToggle(); }} style={[styles.checkbox, checked && styles.checkboxChecked]}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity style={styles.checkRow} onPress={() => { haptic.selection(); setAcceptTerms(!acceptTerms); }}>
            ...
            <TouchableOpacity style={styles.checkRow} onPress={() => { haptic.selection(); setAcceptPrivacy(!acceptPrivacy); }}>
            ...
            <TouchableOpacity onPress={() => { haptic.light(); router.back(); }}>
